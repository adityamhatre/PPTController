...
public class MainActivity extends AppCompatActivity {
    ...
    int currentSlide;
    String buffer;
    String[] dataFromServer; //0:slideCount 1:pptName
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    buffer = bufferedReader.readLine().trim().replace("slideCount_Name", "");
                    dataFromServer = buffer.split("~");
                    slideCount = Integer.parseInt(dataFromServer[0]);
                    updateStatus(1);
                    currentSlide = 1;
                    for (int i = 0; i < 4; i++) {
                        System.out.println("--------");
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ((TextView) findViewById(R.id.name)).setText(dataFromServer[1]);
